...
/**
 * Данный метод похож на метод takeWhile() только он позволяет
 * пропустить элементы, которые удовлетворяют условию.
 * Этот метод также нужно использовать только для отсортированных
 * элементов, т.к. если для первого элемента не выполниться условие,
