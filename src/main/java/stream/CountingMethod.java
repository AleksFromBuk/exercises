 ...
 *
 *  Метод Collectors.groupingBy() всегда первым параметром принимает
 *  функцию, по которой будет строиться ключ. Вторым параметром может
 *  принимать Collector. Большинство методов Collectors возвращают Collector.
 *
 ...
 *
 * Например, напишем код, который будет возвращать
 * Map<String, Long>, где ключ это строка, а значение - число ее вхождений в список
