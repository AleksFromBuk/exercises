 ...
 * использовать компаратор, созданный с помощью метода Comparator.nullsLast().
 * Он аналогичен nullsFirst() за исключением, что null элементы при его
 * применении скопятся в конце.
 *
 * Например:
 *
